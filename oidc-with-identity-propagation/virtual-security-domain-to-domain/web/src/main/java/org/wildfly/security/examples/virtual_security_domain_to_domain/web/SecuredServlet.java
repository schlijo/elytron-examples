...
package org.wildfly.security.examples.virtual_security_domain_to_domain.web;
...
import org.wildfly.security.examples.virtual_security_domain_to_domain.ejb.EntryBean;
...
public class SecuredServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.println(String.format("<p>%s</p>", bean.invokeManagementBean()));
